...
public class AdminFrame extends JFrame {
	...
	static final String PASS = "H@a2fzyyy";
	String s;
	...
	public AdminFrame() {
		...
		l1 = new JLabel(new ImageIcon(AdminFrame.class.getResource("/StudentMgmtSys/smsHEADERFINAL.jpg")));
		...
		lblCourse.setFont(new Font(lblCourse.getName(), Font.BOLD, 20));
		lblCourse.setForeground(Color.blue);
		p4.add(lblCourse);
		lblCourse.setBounds(20, 0, 200, 50);

		// fifth panel
		p5 = new JPanel();
		p5.setLayout(null);
		p5.setBackground(new Color(150, 150, 255));
		JLabel slc = new JLabel("Code");
		...
		JLabel name = new JLabel("Remarks");
		...
		JLabel per = new JLabel("Sessional");
		...
		attached.setFont(new Font(lblCourse.getName(), Font.BOLD, 20));
