...
public class AdminIndividual extends JFrame {
	...
	private void initComponents() {
		...
		jButton1.setIcon(new ImageIcon(AdminIndividual.class.getResource("/StudentMgmtSys/smsHEADERFINAL.jpg"))); // NOI18N
		...
		jLabel16.setForeground(new Color(0, 128, 128));
		...
		jLabel19.setText("Sessionals");

		jLabel20.setFont(new Font("Tahoma", 1, 12)); // NOI18N
		jLabel20.setText("Finals");
		...
		jLabel6.setForeground(new Color(0, 128, 128));
