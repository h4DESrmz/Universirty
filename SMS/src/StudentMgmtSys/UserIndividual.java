...
public class UserIndividual extends JFrame {
	...
	private void initComponents() {
		...
		jButton4.setIcon(new ImageIcon(UserIndividual.class.getResource("/StudentMgmtSys/smsHEADERFINAL.jpg"))); // NOI18N
		...
		jPanel3.setBackground(new Color(0, 191, 255));

		jLabel2.setFont(new Font("Tahoma", 1, 18)); // NOI18N
		jLabel2.setForeground(new Color(0, 128, 128));
